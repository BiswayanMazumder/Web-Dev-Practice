...
let about_movie=document.querySelector('.about');
...
async function fetchbannervid() {
  ...
  onAuthStateChanged(auth, async (user) => {
    if (user) {
      try {
        const uid = user.uid;
        const userDocRef = doc(db, "Movie Details", movienames);
        const docsnap = await getDoc(userDocRef);

        if (docsnap.exists()) {
          var banner_video = docsnap.data().trailer;
          ...
          try {
            ...
            video.addEventListener('ended', function () {
              homepagevideo.innerHTML = `<img src=${poster} alt="" width="100%">`;
            });
...
relatedsection.addEventListener('click', function () {
  ...
  relatedsectionpart.innerHTML=`<div class="img1">
                ...
                <div class="img2">
                    <img src="https://occ-0-2232-2186.1.nflxso.net/dnm/api/v6/Qs00mKCpRvrkl3HZAN5KwEL1kpE/AAAABdG9q7mB7oKiPfsqjUCryoHuhQuqjDVjdoJc5FXRVcb8E3OVzl5tDUPaKNPvAUQMADQq9eP82OB1SXd4QjcCYapJn1qXrOjFKBRUk5FZqMnDdxRZ-jzSYIkB8EARzlNgNE8G_kSJkb_HsmeM9KdQB0JtHEVi7EWGVTx4s2dViGVyGEZC4fVTQpvGXG_dMZ0.jpg?r=02e" alt="">
                </div>
                <div class="img3">
                    <img src="https://occ-0-2232-2186.1.nflxso.net/dnm/api/v6/Qs00mKCpRvrkl3HZAN5KwEL1kpE/AAAABRpeRoDo77ul-qfwHNOoW70duFKZEp4blGQd9cJ249KJiYHKCaJLT1OeOxs7joLuZRhBtwqBLrtVIZAaG8q_fjMM81YzthRK76Bbp8S0igmagdMFjDcifCJQv4w9nuoCgBzC.jpg?r=b12e" alt="">
                </div>
                <div class="img4">
                    <img src="https://occ-0-2232-2186.1.nflxso.net/dnm/api/v6/Qs00mKCpRvrkl3HZAN5KwEL1kpE/AAAABbkyV331oyuwsOqSDmm0KLGlBbGvNEXjljrQavGsMQOvmvP4zMCpnsqH4RXHHZi8wTaelnD4e099KMuZpYto6u9lFvo7YZR9LSErcaWfuzEyDROovjRIWmiBRZAbNoZvd_eDVyo8y_WtjzkZtkwrlE_LChW74sT7hVqWy8ovE0eE1WUokahX7n4-CLDTksQ.jpg?r=361" alt="">
                </div>
                <div class="img5">
