...
export declare const sanitizeInputProps: (obj: ReturnType<typeof useFormField>, keep?: (keyof ReturnType<typeof useFormField>)[]) => {
    value: string;
    name: FieldId;
    type?: "number" | "reset" | "submit" | "search" | "password" | "email" | "image" | "file" | "button" | "time" | "hidden" | "url" | "checkbox" | "radio" | (string & {}) | "color" | "text" | "date" | "tel" | "datetime-local" | "month" | "range" | "week" | undefined;
    isDisabled: boolean;
