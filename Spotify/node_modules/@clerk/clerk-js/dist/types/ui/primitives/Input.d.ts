...
declare const applyVariants: (props?: {
    ...
    readonly shadows: Readonly<{
        ...
        readonly tableBodyShadow: "0px 0px 1px 0px rgba(0, 0, 0, 0.08), 0px 1px 2px 0px rgba(0, 0, 0, 0.12)";
    }>;
...
export declare const Input: React.ForwardRefExoticComponent<Omit<React.ClassAttributes<HTMLInputElement> & React.InputHTMLAttributes<HTMLInputElement> & {
    css?: import("../styledSystem/types").ThemableCssProp;
} & {
    variant?: "default" | "unstyled" | undefined;
} & OwnProps & Partial<Record<"isRequired", boolean>>, "ref"> & React.RefAttributes<HTMLInputElement>>;
export declare const CheckboxInput: React.ForwardRefExoticComponent<Omit<React.ClassAttributes<HTMLInputElement> & React.InputHTMLAttributes<HTMLInputElement> & {
    css?: import("../styledSystem/types").ThemableCssProp;
} & {
    variant?: "default" | "unstyled" | undefined;
} & OwnProps & Partial<Record<"isRequired", boolean>>, "ref"> & React.RefAttributes<HTMLInputElement>>;
export declare const RadioInput: React.ForwardRefExoticComponent<Omit<React.ClassAttributes<HTMLInputElement> & React.InputHTMLAttributes<HTMLInputElement> & {
    css?: import("../styledSystem/types").ThemableCssProp;
} & {
    variant?: "default" | "unstyled" | undefined;
} & OwnProps & Partial<Record<"isRequired", boolean>>, "ref"> & React.RefAttributes<HTMLInputElement>>;
