...
export declare const Th: React.ForwardRefExoticComponent<Omit<React.ClassAttributes<HTMLTableHeaderCellElement> & React.ThHTMLAttributes<HTMLTableHeaderCellElement> & {
    css?: import("../styledSystem/types").ThemableCssProp;
} & Omit<Partial<Record<"isDisabled" | "hasError" | "isLoading" | "isOpen" | "isActive", any>> & React.ClassAttributes<HTMLDivElement> & React.HTMLAttributes<HTMLDivElement> & {
    css?: import("../styledSystem/types").ThemableCssProp;
} & import("../styledSystem").AsProp & {}, "as"> & {}, "ref"> & React.RefAttributes<HTMLTableCellElement>>;
export {};
