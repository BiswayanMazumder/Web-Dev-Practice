...
export declare const PopoverCard: {
    Root: React.ForwardRefExoticComponent<Omit<Omit<Omit<Partial<Record<"isDisabled" | "hasError" | "isLoading" | "isOpen" | "isActive", any>> & React.ClassAttributes<HTMLDivElement> & React.HTMLAttributes<HTMLDivElement> & {
