...
export declare const CardClerkAndPagesTag: React.MemoExoticComponent<React.ForwardRefExoticComponent<Omit<Omit<Partial<Record<"isDisabled" | "hasError" | "isLoading" | "isOpen" | "isActive", any>> & React.ClassAttributes<HTMLDivElement> & React.HTMLAttributes<HTMLDivElement> & {
